...
async function adminSavePDF() {
  ...
  try {
    ...
    const payload = {
      ...
      subcategory:       _isValidClassif(subcategory)   ? subcategory   : null,
      subcategory_id:    subcategoryId,
      academic_level:    _isValidClassif(academicLevel) ? academicLevel : null,
      academic_level_id: academicLevelId,
      stream:            _isValidClassif(stream)        ? stream        : null,
      stream_id:         streamId,
      semester_class:    _isValidClassif(semesterClass) ? semesterClass : null,
      semester_class_id: semesterClassId,
      subject:           _isValidClassif(subject)       ? subject       : null,
