...
;(function StudyriaPWA32() {
    ...
    function _render() {
      ...
      filteredNotes.forEach(function(n, i) {
        ...
        if (n.improved && n.improved.length) {
          html += '<div class="pwa32-wn-group"><div class="pwa32-wn-group-title" style="color:#7d1122">⚡ Improved</div>';
  ...
  async function renderPWAPage() {
    ...
    // What's New Center
    html += '<div class="pwa32-section"><div class="pwa32-section-title">What\'s New' + (unreadCount > 0 ? ' <span style="background:#7d1122;color:#fff;font-size:.66rem;padding:2px 8px;border-radius:10px">' + unreadCount + '</span>' : '') + '</div>';
    html += '<div id="pwa32WhatsNew"></div>';
    html += '</div>';

    // Notifications
    html += '<div class="pwa32-section"><div class="pwa32-section-title">Notifications' + (_getUnreadNotifCount() > 0 ? ' <span style="background:#7d1122;color:#fff;font-size:.66rem;padding:2px 8px;border-radius:10px">' + _getUnreadNotifCount() + '</span>' : '') + '</div>';
