...
(function () {
  ...
  var DEFAULT_PLANS = [
    { passId:'trial_1day',  name:'1 Day Trial',  offerPrice:9,   originalPrice:0,   duration:'1',   durationUnit:'days',    badge:'⚡ NEW',         badgeType:'blue',   buttonText:'Try Now',        icon:'⚡', gradient:'linear-gradient(135deg,#930205,#c99a3c)', order:1, active:true, discount:0 },
    { passId:'trial_7day',  name:'7 Day Trial',  offerPrice:29,  originalPrice:49,  duration:'7',   durationUnit:'days',    badge:'🌟 POPULAR',     badgeType:'green',  buttonText:'Get Pass',       icon:'🌟', gradient:'linear-gradient(135deg,#10d98e,#930205)', order:2, active:true, discount:41 },
    ...
    { passId:'monthly',     name:'Monthly',      offerPrice:69,  originalPrice:149, duration:'30',  durationUnit:'days',    badge:'',               badgeType:'blue',   buttonText:'Subscribe',      icon:'🔵', gradient:'linear-gradient(135deg,#930205,#8b5cf6)', order:4, active:true, discount:54 },
