...
const CP_LEVELS = {
  ...
  pro:     { label:'Pro',     share:70, icon:'💎', color:'#3d8ef8', minSales:25000 }
};
  ...
  main.innerHTML = `
    ...
    <div class="crd-score-card">
      ...
      <div class="crd-score-bar-row">
        ...
        <div class="crd-score-track"><div class="crd-score-fill" style="width:${creator.originality_score||0}%;background:linear-gradient(90deg,#3d8ef8,#00c8e8)"></div></div>
        <div class="crd-score-val" style="color:#3d8ef8">${creator.originality_score||0}</div>
      </div>
      <div class="crd-score-bar-row">
...
async function crdRenderPdfs(main) {
  ...
  try {
    ...
    main.innerHTML = `
      ...
      .crd-pdf-card-cover{width:52px;height:72px;border-radius:10px;background:linear-gradient(135deg,rgba(61,142,248,0.25),rgba(16,217,142,0.15));display:flex;align-items:center;justify-content:center;font-size:1.5rem;flex-shrink:0;border:1px solid rgba(61,142,248,0.2)}
      ...
      .crd-pdf-act-preview{color:#3d8ef8;background:rgba(61,142,248,0.1);border:1px solid rgba(61,142,248,0.28)}
      .crd-pdf-act-preview:hover{background:rgba(61,142,248,0.2)}
...
async function renderCreatorManagerAdmin() {
  ...
  .cm2-badge-pro{background:rgba(61,142,248,0.15);color:#3d8ef8;border:1px solid rgba(61,142,248,0.3)}
          ...
          <tr>
            ...
            <td>
              ...
              <div title="Originality: ${c.originality_score||0}/100" style="margin-top:4px">
                <div class="cm2-score-bar"><div class="cm2-score-fill" style="width:${c.originality_score||0}%;background:linear-gradient(90deg,#3d8ef8,#00c8e8)"></div></div>
            ...
            ${pdfRows.map(p => {
              ...
              <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:rgba(255,255,255,0.03);border:1px solid var(--glass-border);border-radius:12px;font-size:.78rem;flex-wrap:wrap">
                ...
                <a href="${cm2EscapeHtml(pdfSignedUrl)}" target="_blank" rel="noopener"
                   style="display:inline-flex;align-items:center;gap:4px;padding:5px 11px;border-radius:8px;font-size:.72rem;font-weight:700;cursor:pointer;text-decoration:none;color:#3d8ef8;background:rgba(61,142,248,0.1);border:1px solid rgba(61,142,248,0.28);white-space:nowrap">
                  👁 Preview
                </a>
