...
export const POSTER_THEMES = [
  { bg: ['#0d1b3e','#1a3a6b','#0a2044'], accent: '#7d1122', accent2: '#c99a3c', icon: '💼' },
  { bg: ['#1a0d3e','#2d1a6b','#12044a'], accent: '#8b5cf6', accent2: '#c99a3c', icon: '🎓' },
  ...
  { bg: ['#0d2e3e','#1a5c6b','#0a3040'], accent: '#c99a3c', accent2: '#67e8f9', icon: '🚀' },
  { bg: ['#1e0d3e','#3d1a6b','#160844'], accent: '#c99a3c', accent2: '#ddd6fe', icon: '✨' },
  { bg: ['#1a2e0d','#3a6b1a','#1e3a0a'], accent: '#84cc16', accent2: '#bef264', icon: '📋' },
  { bg: ['#3e2e0d','#6b4a10','#4a3008'], accent: '#f97316', accent2: '#fdba74', icon: '💰' },
  { bg: ['#0d1e3e','#1a3a6b','#081840'], accent: '#c99a3c', accent2: '#bfdbfe', icon: '🎯' },
