  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    client.auth.onAuthStateChange(function (event, session) {
      ...
      if (event === 'INITIAL_SESSION') {
        ...
        // Load wishlist from Supabase for the restored session
        if (user && typeof window.loadWishlistFromSupabase === 'function') {
      ...
      if (event === 'SIGNED_IN') {
        window.syncNavToAuth(user);
        // Load wishlist & bust dashboard cache for the newly signed-in user
        if (user && typeof window.loadWishlistFromSupabase === 'function') {
          window.loadWishlistFromSupabase();
        }
      ...
      if (event === 'SIGNED_OUT') {
        ...
        // Clear local wishlist and dashboard cache on logout
