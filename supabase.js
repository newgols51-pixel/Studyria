...
(function () {
  ...
  // We use the window.supabase object captured BEFORE the inline script
  // block can overwrite window.supabase with its proxy alias.
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Point window.supabase to the initialized client so that any
    // code using `window.supabase` or the inline-script `supabase`
    // variable (now also checking window.supabaseClient) gets the
    // real client rather than the CDN namespace object.
